...
{
    public GameObject deadEnd, roadStraight, corner, threeWay, fourWayLights;
    ...
    public void FixRoadAtPosition(PlacementManager placementManager, Vector3Int temporaryPosition)
    {
        ...
        {
            Create4WayLights(placementManager, result, temporaryPosition);
        }
    }
    ...
    //}
    private void Create4WayLights(PlacementManager placementManager, CellType[] result, Vector3Int temporaryPosition)
    {
        placementManager.ModifyStructureModel(temporaryPosition, fourWayLights, Quaternion.identity);
